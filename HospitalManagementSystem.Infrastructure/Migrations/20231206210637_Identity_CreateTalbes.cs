...
{
    /// <inheritdoc />
    public partial class Identity_CreateTalbes : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvilableFor = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TakedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Medicines_Admins_HospitalAdminId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Patients_Admins_HospitalAdminId",
                        column: x => x.HospitalAdminId,
                        principalTable: "Admins",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attatchment_Patients_PatientId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Image_Medicines_MedicineId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attatchment_PatientId",
                table: "Attatchment",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_Image_MedicineId",
                table: "Image",
                column: "MedicineId",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Medicines_HospitalAdminId",
                table: "Medicines",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Patients_HospitalAdminId",
                table: "Patients",
                column: "HospitalAdminId");
